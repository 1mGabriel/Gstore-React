...
const PsnPerifericos = () => {
    const { psnPerifericosData, setPsnPerifericosData, getData } = useContext(StatesContext);

    // Faz a requisição
    useEffect(()=>{
        getData("https://g-store-db-json.vercel.app/psn-perifericos", setPsnPerifericosData)
      },[])
  ...
  return (
    ...
    <div className="main-product-content">
        {psnPerifericosData.map((console)=>(

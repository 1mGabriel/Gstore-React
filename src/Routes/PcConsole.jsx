...
const PcConsole = () => {
    const { pcConsoleData, setPcConsoleData,getData } = useContext(StatesContext);

    // Faz a requisição
    useEffect(()=>{
        getData("https://g-store-db-json.vercel.app/pc-console", setPcConsoleData)
      },[])

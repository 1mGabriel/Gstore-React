...
const PsnConsole = () => {
    const { psnConsoleData, setPsnConsoleData, getData } = useContext(StatesContext);

    // Faz a requisição
    useEffect(()=>{
        getData("https://g-store-db-json.vercel.app/psn-console", setPsnConsoleData)
      },[])

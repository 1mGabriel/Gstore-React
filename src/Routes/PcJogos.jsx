...
const PcJogos = () => {
    const { pcJogosData, setPcJogosData, getData } = useContext(StatesContext);

    // Faz a requisição
    useEffect(()=>{
        getData("https://g-store-db-json.vercel.app/pc-jogos", setPcJogosData)
      },[])
